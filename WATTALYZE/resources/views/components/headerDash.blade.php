...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            /* Ajuste do dropdown de notificações */
            .dropdown-menu {
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            ...
            <!-- Itens do navbar -->
            <div class="d-flex ms-auto align-items-center flex-wrap">
                <!-- Notificações -->
                <div class="dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="alertsDropdown" style="min-width: 250px; max-width: 300px;">
                        <li class="dropdown-header fw-bold">Notificações</li>
                        @forelse($alerts as $alert)
                        <li>
                            <a href="{{ route('alerts.active') }}" class="dropdown-item small">
